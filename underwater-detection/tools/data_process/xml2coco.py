...
def main():
    ...
    # cvt_annotations(img_path, xml_path, '../data/train/annotations/trainall.json')
    # print('Done!')
    ...
    # print("val data!")
    # xml_path = '../data/train/val-box'
    # img_path = '../data/train/val-image'
    # print('processing {} ...'.format("xml format annotations"))
    # os.makedirs('../data/train/annotations/', exist_ok=True)
    # cvt_annotations(img_path, xml_path, '../data/train/annotations/val.json')
    # print('Done!')
