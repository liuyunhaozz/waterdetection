...
test_cfg = dict(
    ...
    #     max_per_img=100))
    rcnn=dict(
        score_thr=0.001,  # 注意这里可以改成0.0001
        nms=dict(type='soft_nms', iou_threshold=0.5, min_score=0.001), max_per_img=100))  # 注意这里的改动
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'train/train-image/',
...
optimizer = dict(type='Adam', lr=2.4e-04)
